class CfgPatches
{
	class 79th_Main_Uniform
	{
		name = "79th Main Uniform";
		author = "Bravocado & Panda";
		requiredVersion = 0.01;
		requiredAddons[] = {};
		// List of objects (CfgVehicles classes) contained in the addon. Important also for Zeus content (units and groups) unlocking.
		units[] = {"79_Base_Uniform","79th_CloneArmor_Trooper"};
		// List of weapons (CfgWeapons classes) contained in the addon.
		weapons[] = {"79th_Clone_Trooper"};
	};
};
...
class CfgVehicles
{
	...
	class 79_Base_Uniform: JLTS_Clone_P2_DC15A_187
	...
	class 79th_CloneArmor_Trooper: 79_Base_Uniform
	{
	    author = "Bravocado & Panda";
	    dlc = "79th Aux Mod";
	    scope = 1;
	    ...
	    hiddenSelectionsTextures[] = {
	        "\79th\Data\Uniforms\snth_armor_1_co.paa",
...
class CfgWeapons
{
	...
	class 79th_Clone_Trooper : JLTS_CloneArmor
	{
		author  = "Bravocado & Panda";
		dlc             = "79th Aux Mod";
		scope   = 2;
		scopeCurator = 2;
		displayName = "[79th] Clone Armor (Trooper)";
		picture = "\MRC\JLTS\characters\CloneArmor\data\ui\CloneArmor_ui_ca.paa";
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			uniformType = "Neopren";
			uniformClass = "79th_CloneArmor_Trooper";
