class CfgPatches
{
	class 79th_Recruit_Uniform
	{
		...
		units[] = {"Aux79_Uniform_ARC"};
		// List of weapons (CfgWeapons classes) contained in the addon.
		weapons[] = {"79th_Clone_ARC"};
	};
};
...
class CfgVehicles
{
	...
	class Aux79_Uniform_ARC: 79_Base_Uniform
	{
	    author = "Bravocado & Panda";
	    dlc = "79th Aux Mod";
	    scope = 1;
	...
	hiddenSelectionsTextures[] = {
	        "\79th\Data\Uniforms\snth_arc_armor_1_co.paa",
...
class CfgWeapons
{
	...
	class 79th_Clone_ARC : JLTS_CloneArmor
	{
		author  = "Bravocado & Panda";
		dlc             = "79th Aux Mod";
		scope   = 2;
		scopeCurator = 2;
		displayName = "[79th] Clone ARC Armor";
		picture = "\MRC\JLTS\characters\CloneArmor\data\ui\CloneArmor_ui_ca.paa";
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			uniformType = "Neopren";
			uniformClass = "Aux79_Uniform_ARC";
