class CfgPatches
{
	class 79th_ARFMBC_Uniform
	{
		name = "79th ARF Uniform (MBC)";
		author = "Bravocado & Panda";
		requiredVersion = 0.01;
		requiredAddons[] = {};
		// List of objects (CfgVehicles classes) contained in the addon. Important also for Zeus content (units and groups) unlocking.
		units[] = {"Aux79_Uniform_ARFMBC"};
		// List of weapons (CfgWeapons classes) contained in the addon.
		weapons[] = {"79th_Clone_ARFMBC"};
	};
};
...
class CfgVehicles
{
	...
	class Aux79_Uniform_ARFMBC: 79_Base_Uniform
	{
	    author = "Bravocado & Panda";
	    dlc = "79th Aux Mod";
	    scope = 1;
	    ...
	    hiddenSelectionsTextures[] = {
	        "\79th\Data\Uniforms\79th1mbc.paa",
	        "\79th\Data\Uniforms\79th2mbc.paa",
	    };
	    class Wounds {
	        tex[] = {};
	        mat[] = {
...
class CfgWeapons
{
	...
	class 79th_Clone_ARFMBC : JLTS_CloneArmor
	{
		author  = "PraetorPanda";
		dlc             = "79th Aux Mod";
		scope   = 2;
		scopeCurator = 2;
		displayName = "[79th] Clone ARF Armor (MBC)";
		picture = "\MRC\JLTS\characters\CloneArmor\data\ui\CloneArmor_ui_ca.paa";
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			uniformType = "Neopren";
			uniformClass = "Aux79_Uniform_ARFMBC";
